...
pie(rc,lab=popis,col=2:7,main="Relativni cetnosti trid automobilu")
...
############################
# Krabicovy graf
boxplot(hp,col="gold",border="blue",main="Krabicovy graf",
        ylab="Sila vozu")
  # samostatne body ukazuji odlehla pozorovani
  boxplot(hp,col="gold",border="darkblue",main="Krabicovy graf",
