...
plot(as.factor(valce)~as.factor(rychlosti), col=2:4, main = "souvislosti počtu válců s rychlostmi aut")
# nacteni dat
...
# PRIKLAD 8. OD BODIKA
dbinom(2,20,0.02) # P(X=2)
dbinom(0,20,0.02) # P(X=0)
pbinom(2,20,0.02) # P(X<=2)

#PRIKLAD 10. OD BODIKA
...
# PRIKLAD 16. OD BODIKA
1 - phyper(2.5,15,10,5)

## Geometricke rozdeleni: p - pravdepodobnost uspechu (cekani na prvni uspech)
